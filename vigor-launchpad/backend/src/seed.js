/**
 * Seeds the file-backed database with realistic sample data covering every
 * module of the Vigor Launchpad platform. Safe to re-run: it wipes the
 * /data directory and rebuilds it from scratch.
 */
const fs = require("fs");
...
const userRows = users.map((u) => db.insert("users", u));
